...
top_15_AP_HDI %>% inner_join(top_15_DP_HDI, by="Country") %>% 
  select(Country) %>%
  arrange(Country)%>%
...
##### 5d Response) Given the slope of the lm is up and to the right, this indicates a positive relationship between Age and Income.
...
##### 5e Point Plot Response) It is difficult to provide an answer based upon the above plot.
...
##### 5e Bar Plot Response) There is a relationship between  Life Satisfaction and HDI, values are higher for the high human developed countries and the values go down quickly and fall to zero as you move towards low human developmed countries.
