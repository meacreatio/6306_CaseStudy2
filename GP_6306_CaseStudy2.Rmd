...
# fix years at job
# if the value is 999, we have to assume in invalid value and default to zero
df.procrastination$YearsAtJob <- sapply(df.procrastination$YearsAtJob, function(x) {
  value = 0
  if(!is.na(x) & x == 999) {
    value = 0
  }
